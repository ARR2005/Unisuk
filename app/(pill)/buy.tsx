...
export default function BuyScreen() {
  ...
  const pickupMethod = 'On-campus pick-up';
  ...
  function confirmPurchase() {
    ...
    // NOTE: To persist this purchase you'd add a notification or write to DB.json here.
  }

  function contactSeller() {
    // Navigate to pill chat group
    router.push('/(pill)/chat' as any);
  }
    ...
    <ScrollView className="flex-1 bg-white" contentContainerStyle={{ paddingBottom: 48 }}>
      <View className="px-4 pt-6">
        ...
        <View className="mt-4 p-4 bg-gray-50 rounded-lg">
          ...
          <Text className="text-sm text-gray-600 mt-1">{pickupMethod}</Text>
        </View>
        ...
        <View className="mt-6">
          ...
          <TouchableOpacity className="w-full border border-gray-300 px-4 py-3 rounded-md" onPress={contactSeller}>
            <Text className="text-center">Contact Seller</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
